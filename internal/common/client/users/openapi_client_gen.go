...
type ClientInterface interface {
	...
	SignUpUser(ctx context.Context, body SignUpUserJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
}
...
func (c *Client) SignUpUserWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewSignUpUserRequestWithBody(c.Server, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) SignUpUser(ctx context.Context, body SignUpUserJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewSignUpUserRequest(c.Server, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func NewSignUpUserRequest(server string, body SignUpUserJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewSignUpUserRequestWithBody(server, "application/json", bodyReader)
}

// NewSignUpUserRequestWithBody generates requests for SignUpUser with any type of body
func NewSignUpUserRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	var err error
...
type ClientWithResponsesInterface interface {
	...
	SignUpUserWithResponse(ctx context.Context, body SignUpUserJSONRequestBody, reqEditors ...RequestEditorFn) (*SignUpUserResponse, error)
}
...
func (c *ClientWithResponses) SignUpUserWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*SignUpUserResponse, error) {
	rsp, err := c.SignUpUserWithBody(ctx, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) SignUpUserWithResponse(ctx context.Context, body SignUpUserJSONRequestBody, reqEditors ...RequestEditorFn) (*SignUpUserResponse, error) {
	rsp, err := c.SignUpUser(ctx, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseSignUpUserResponse(rsp)
